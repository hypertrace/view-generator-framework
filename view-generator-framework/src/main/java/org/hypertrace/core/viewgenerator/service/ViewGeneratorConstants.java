...
public class ViewGeneratorConstants {
  ...
  public static final String DEFAULT_VIEW_GEN_JOB_CONFIG_KEY = "view-gen-job-config-key";
  public static final String MULTI_VIEW_GEN_JOB_CONFIG = "multi-view-gen-job-config";
}
