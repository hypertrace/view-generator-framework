        ...
        if (convertedSpec != null) {
          ...
          if (field.schema().getType().equals(Type.MAP)) {
            ...
            if (convertedSpec.getName().endsWith(PINOT_SCHEMA_MAP_VALUES_SUFFIX)) {
              ...
              // defaults
              // don't necessarily work for us. For example, it sets minimum value possible for all
              // numerical fields but that is prone to messing up querying, we prefer default of 0
